import 'package:doctor_c/controller/doctor/update_appointment_controller.dart';
                    ...
                    child: Container(
                        ...
                        child: Button('Update appointment', () {
                          AppointmentModel appointment = AppointmentModel(
                            validation: true,
                            doctorId: Apis.currentAuthenticateuser.uid,
                            patientId: controller.patient.id,
                            dateTime: _currentDay,
                          );
                          if (_timeSelected && _dateSelected) {
                            controller.getDeviceToken().then((value) async {
                              var data = {
                                'to': controller.patient.token,
                                'priority': 'high',
                                'notification': {
                                  'title': 'appointment changed',
                                  'body':
                                      'Your date has been changed to ${_currentDay}',
                                }
                              };
                              await http.post(
                                  Uri.parse(
